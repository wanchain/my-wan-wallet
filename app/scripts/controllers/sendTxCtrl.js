    ...
    $scope.sendTx = function () {
        ...
        uiFuncs.sendTx($scope.signedTx, function (resp) {
            if (!resp.isError) {
                ...
                // var emailBtn = '<a class="btn btn-xs btn-info " href="mailto:support@wanchain.org?Subject=Issue%20regarding%20my%20TX%20&Body=' + emailBody + '" target="_blank" rel="noopener noreferrer">Confused? Email Us.</a>'
