...
ethUtil.Tx = require('wanchainjs-tx')
...
var stakingCtrl = require('./controllers/stakingCtrl')
...
Sentry.init({
    dsn: 'https://061ff72d96d64c7bb85690ec2fb82688@sentry.io/1274640',
    integrations: [
        new Integrations.Angular(),
    ],
})

var app = angular.module('mewApp', ['ngSentry', 'pascalprecht.translate', 'ngSanitize', 'ngAnimate'])
...
app.controller('stakingCtrl', ['$scope', '$sce', 'walletService', '$rootScope', stakingCtrl])
