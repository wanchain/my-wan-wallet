...
SEND_Warning_1: 'Warning! You do not have enough funds to complete this transaction.',
SEND_Warning_2: 'Please add more funds to your wallet or access a different wallet.',
...
X_HelpfulLinks_4: 'Migrating to/from MyWanWallet',
...
EOS_06: 'Go to Send Wancoins & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title: 'Welcome to MyWanWallet.com',
...
ONBOARD_welcome_content__5: 'MyWanWallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title: 'MyWanWallet is not a Bank',
...
ONBOARD_interface_title: 'MyWanWallet is an Interface',
ONBOARD_interface_content__1: 'When you create an account on MyWanWallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_blockchain_content__4: 'The blocks in the blockchain are made up of all the individual transactions sent from MyWanWallet, WanMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5: 'When you see your balance on MyWanWallet.com or view your transactions on [wanscan.org](https://wanscan.org), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_secure_1_content__3: 'Always check the URL: `https://www.MyWanWallet.com`.',
ONBOARD_secure_1_content__4: 'Always make sure the URL bar has `MyWanWallet.com` in green.',
...
STAKING_Title: 'Validator Address',
STAKING_Title_2: 'Select Validator',
NAV_SendStake: 'Stake to',
NAV_WithdrawStake: 'Withdraw from',
STAKE_amount: 'Amount to Stake (Min 100 for new delegation)',
STAKE_amount_short: 'Amount',
STAKE_GAS_LIMIT_Desc: 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. It should be generated automatically. If its -1 you are trying to do something that will not work',
STAKE_Amount_Desc: 'The minimum amount to delegate is 100Wan. If you are already delegation you can send any amount',
STAKEModal_Content_1: 'You are about to delegate',
STAKEModal_Content_2: 'to address',
STAKEModal_Content_3: 'Are you sure you want to do this?',
STAKEModal_Content_4: 'NOTE: If you encounter an error, you most likely need to add Wancoins to your account to cover the gas cost of sending tokens. Gas is paid in Wancoins.',
STAKEModal_Content_5: 'You are about to undelegate',
STAKEModal_No: 'No, get me out of here!',
STAKEModal_Title: 'Warning!',
STAKEModal_Yes: 'Yes, I am sure! Make transaction.',
STAKING_Warning_1: 'Warning! You do not have enough funds to stake this much.',
STAKING_Warning_2: 'Please add more funds to your wallet or access a different wallet.',
STAKE_gas: 'Gas Limit (-1 means validator is full or you are not delegating minimum 100 Wan)',
STAKE_gas2: 'Gas Limit (-1 means you are not delegated to this validator)',
...
PARITY_AlreadyImported: '(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [wanscan.org](https://wanscan.org) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)',
...
FOOTER_1: 'Free, open-source, client-side interface for generating Wanchain wallets &amp; more. Interact with the Wanchain blockchain easily &amp; securely. Double-check the URL ( MyWanWallet.com ) before unlocking your wallet.',
...
GEN_Label_5: 'Save Your `Private Keys`.',
...
NODE_Warning: 'Your node must be HTTPS in order to connect to it via MyWanWallet.com. You can [download the MyWanWallet repo & run it locally](https://github.com/wanchain/my-wan-wallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
OFFLINE_Step2_Label_8: 'Gas Used',
OFFLINE_Step2_Label_9: 'Transaction Status',
...
x_WAddress: 'Your Private Address',
x_Cancel: 'Cancel',
...
x_PrivKey2: 'Private Key 2 (unencrypted)',
...
x_PrivKeyDesc2: 'This is the unencrypted text version of your second private key, meaning no password is necessary. If someone were to find your unencrypted private key, they could access your wallet without a password. For this reason, encrypted versions are typically recommended.',
...
HELP_14_Desc_1: 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, MyWanWallet.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title: '14) Some sites randomize (seed) the private key generation via mouse movements. MyWanWallet.com doesn\'t do this. Is the random number generation for MyWanWallet safe?',
...
HELP_15_Title: '15) Why hasn\'t the account I just created show up in the blockchain explorer? (ie: wanscan.org)',
HELP_16_Desc_1: 'You can use a blockchain explorer like [wanscan.org](https://wanscan.org/). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://wanscan.org/addr/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) looks like on wanscan.org',
...
HELP_2b_Desc_1: 'Go to [https://github.com/wanchain/my-wan-wallet/releases/latest](https://github.com/wanchain/my-wan-wallet/releases/latest).',
HELP_2b_Desc_2: 'Click on `my-wan-wallet-vX.X.X.X.zip`.',
...
HELP_3_Desc_3: 'Navigate to the MyWanWallet.com "View Wallet Info" page.',
...
HELP_5_Desc_1: 'You can run MyWanWallet.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7: 'MyWanWallet.com is now running entirely on your computer.',
...
HELP_5_Desc_9: 'As we are constantly updating MyWanWallet.com, we recommend you periodically update your saved version of the repo.',
HELP_5_Title: '5) How do I run MyWanWallet.com offline/locally?',
...
HELP_7_Desc_0: '[wanscan.org](https://wanscan.org/) is a great way to explore tokens and find the decimals of a token.',
...
HELP_8_Desc_2: 'If MyWanWallet.com goes down, you would have to find another way (like gwan or Wanchain Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Wancoins out of MyWanWallet because it\'s not in MyWanWallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8_Desc_4: 'In addition, the likelihood of us taking MyWanWallet down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/wanchain/mywanwallet](https://github.com/wanchain/mywanwallet). You can download the ZIP there and run it locally.',
...
HELP_Desc: 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@MyWanWallet.com), and we will not only answer your question, we will update this page to be more useful to people in the future!',
...
HELP_Remind_Desc_2: 'MyWanWallet.com & MyWanWallet CX are not "web wallets". You do not create an account or give us your Wancoins to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_Sec_Desc_4: 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/wanchain/my-wan-wallet/releases/latest](https://github.com/wanchain/my-wan-wallet/releases/latest) to [https://www.MyWanWallet.com](https://www.MyWanWallet.com).',
HELP_Sec_Desc_5: 'For generating wallets, you can download the [source code and run it locally](https://github.com/wanchain/my-wan-wallet/releases/latest). See #5 above.',
...
HELP_SecCX_Desc_6: 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use MyWanWallet.com instead of this Chrome Extension.',
