...
var ens = function () {
    ...
    this.resolverABI = {}
    for (i in resolverInterface) this.resolverABI[resolverInterface[i].name] = resolverInterface[i]
    this.auctionABI = {}
    for (i in auctionInterface) this.auctionABI[auctionInterface[i].name] = auctionInterface[i]
    this.deedABI = {}
    for (i in deedInterface) this.deedABI[deedInterface[i].name] = deedInterface[i]
    switch (ajaxReq.type) {
