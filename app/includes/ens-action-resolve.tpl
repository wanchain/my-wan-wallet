<article class="col-xs-12 col-sm-10 col-sm-offset-1" ng-show="objENS.status==ensModes.owned && objENS.owner==objENS.deedOwner && wd">
  ...
  <div class="alert alert-danger"
       ng-show="objENS.owner != wallet.getAddressString()">
          This account is not the owner of {{objENS.name}}.wan.
         ...
         ng-hide="1===1 || objENS.owner != wallet.getAddressString()">
            ...
            <button class="btn btn-primary"
                    ng-click="resolveDomain()">
                         Set Public Resolver &amp; Set Address for {{objENS.name}}.wan
            </button>
  ...
  <div class="form-group" style="margin: 2em auto;">
    ...
    <ol>
      ...
      <li>
        Choose <code>WNS - Registry:</code> <code>0xee8d418fd33e69782015ea4313dfd8eb7b1b91ce</code>. Click "Access".
      </li>
      <li>
      ...
      <li>
        ...
        <ul>
          <li>
            resolver (address): <code>0x330b6f07f6ace581fc4321ce7f401aa8edb5bfad</code>
          </li>
        </ul>
      </li>
      <li>
  ...
  <div class="form-group" style="margin: 2em auto;">
    ...
    <ol>
      ...
      <li>
        Choose <code>WNS-Public Resolver:</code> <code>0x330b6f07f6ace581fc4321ce7f401aa8edb5bfad</code>. Click "Access".
      </li>
      <li>
