<article class="col-xs-12 col-sm-8 col-sm-offset-2 text-center"
  ...
  <p translate="ENS_Finalize_content">
    Finalizing this name assigns the WNS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.1 WAN. Any non-winners will also be refunded.
  </p>
  <br />
