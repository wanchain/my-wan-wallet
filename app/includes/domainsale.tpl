    ...
    <section class="clearfix collapse-container">
      <div class="text-center" ng-click="wd = !wd">
        ...
        <h4>
          ...
          <span ng-show="objDomainSale.status==domainsaleModes.nottransferred && wallet==null">    Do you own and want to sell {{objDomainSale.name}}.wan? Unlock your Wallet to transfer the domain to DomainSale </span>
          <span ng-show="objDomainSale.status==domainsaleModes.notoffered && wallet==null">    Do you own and want to set prices for {{objDomainSale.name}}.wan? Unlock your Wallet to set buy and bid price </span>
          <span ng-show="objDomainSale.status==domainsaleModes.available && objDomainSale.price!=0 && objDomainSale.reserve==0 && wallet==null">    Do you want to buy {{objDomainSale.name}}.wan? Unlock your Wallet to buy it immediately </span>
          <span ng-show="objDomainSale.status==domainsaleModes.available && objDomainSale.price==0 && objDomainSale.reserve!=0 && wallet==null">    Do you want to bid for {{objDomainSale.name}}.wan? Unlock your Wallet to place a bid </span>
          <span ng-show="objDomainSale.status==domainsaleModes.available && objDomainSale.price!=0 && objDomainSale.reserve!=0 && wallet==null">    Do you want to buy or bid for {{objDomainSale.name}}.wan? Unlock your Wallet to continue </span>
          <span ng-show="objDomainSale.status==domainsaleModes.auctioning && wallet==null">    Do you want to bid for {{objDomainSale.name}}.wan? Unlock your Wallet to place a bid </span>
          <span ng-show="objDomainSale.status==domainsaleModes.closed && wallet==null">    Did you buy or sell {{objDomainSale.name}}.wan? Unlock your Wallet to finish the auction </span>
