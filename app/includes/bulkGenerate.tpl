    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="alert alert-danger" translate="ERROR_28">
          **You need your Keystore File + password or Private Key** to access this wallet in the future. Please save & back it up externally! There is no way to recover a wallet if you do not save it. Read the [help page](https://mywanwallet.com/#help) for instructions.
        </div>
      </div>
