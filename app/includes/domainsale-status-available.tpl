...
<div ng-show="objDomainSale.price==0 && objDomainSale.reserve>0">
  <h1><strong>{{objDomainSale.name}}.wan</strong> is available for auction.</h1>
...
<div ng-show="objDomainSale.price>0 && objDomainSale.reserve==0">
  <h1><strong>{{objDomainSale.name}}.wan</strong> is available for purchase.</h1>
...
<div ng-show="objDomainSale.price>0 && objDomainSale.reserve>0">
  <h1><strong>{{objDomainSale.name}}.wan</strong> is available for purchase or auction.</h1>
