      ...
      <div class="modal-body">
            ...
            <div class="col-xs-12 col-sm-7 onboarding__content">
              ...
              <ul>
                <li translate="ONBOARD_welcome_content__5">
                  MyWanWallet is a free, open-source, client-side interface.
                </li>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on MyWanWallet.com or view your transactions on [wanscan.org](https://wanscan.org), you are seeing data on the blockchain, not in our personal systems.
                </li>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==6">
          <h3 class="onboarding__title" translate="ONBOARD_whymew_title">
            If MyWanWallet can't do those things, what's the point?
          </h3>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-4 onboarding__image">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==7">
          ...
          <p translate="ONBOARD_secure_1_content__1">
            Phishers send you a message with a link to a website that looks just like MyWanWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.
          </p>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_secure_1_content__3">
                  Always check the URL: `https://mywanwallet.com`.
                </li>
