  ...
  <article class="row">
    ...
    <section class="col-sm-8">
      ...
      <div class="form-group well" ng-show="objENS.txSent && (objENS.status==ensModes.auction || objENS.status==ensModes.open)">
        ...
        <p>Please check your address on <a href="https://wanscan.org/">https://wanscan.org/</a> to ensure your BID TX is on the blockchain, without errors.</p>
      ...
      <div class="form-group" ng-show="objENS.txSent && objENS.status==ensModes.reveal">
        <h4 class="text-warning">
          Click your TX hash to see if you successfully revealed your {{objENS.bidValue}} bid for {{objENS.name}}.wan.
        </h4>
        <p>
