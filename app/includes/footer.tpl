...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--righ">
      ...
      <p>
        <a aria-label="support email" href="mailto:support@mywanwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Email support: support@mywanwallet.com
        </a>
      </p>
      <p>
      ...
      <p>
        <a aria-label="Download Offline" href="https://mywanwallet.com/wanwallet-latest.zip" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Download Offline
        </a>
      </p>
      ...
      <p>
        ...
        <a aria-label="github" title="github" href="https://github.com/C3Devs" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="support email" title="support email" href="mailto:support@mywanwallet.com" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
