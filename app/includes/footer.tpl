...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--cent">
        ...
        <p>
          <a aria-label="wan stats" href="https://wanstats.io" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
            WanStats.io
          </a>
        </p>
        <p>
    ...
    <section class="footer--righ">
      ...
      <p>
        ...
        <a aria-label="github" title="github" href="https://github.com/wanchain" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
