<main class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.signMessage.id" ng-controller='signMsgCtrl' ng-cloak>
    ...
    <article class="row block" ng-show="visibility=='signView'">
    ...
    <article class="row block" ng-show="visibility=='verifyView'">
        <section class="block">
