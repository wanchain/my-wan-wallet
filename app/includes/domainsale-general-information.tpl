  ...
  <div class="cont-md">
    ...
    <h4> General </h4>
      ...
      <ul ng-show="domainsaleMore">
         <li> The <a href="https://github.com/wanchain/domainsalewan/" target="_blank" rel="noopener noreferrer">DomainSale contract</a> is open source and freely available.</li>
